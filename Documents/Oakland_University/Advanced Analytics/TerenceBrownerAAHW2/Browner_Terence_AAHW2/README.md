...
```bash
cookiecutter gh:terencebrowner/cookiecutter-datascience-simple
```
...
For the remote repository, make a github repository named BrownerTerenceAAHW2, then do;

```bash
git remote add origin git@github.com:terencebrowner/BrownerTerenceAAHW2.git
git branch -M main
...
Here's the folder structure that gets created by `cookiecutter-datascience-simple`:
	...
	├── BrownerTerenceAAHW2	<- Your notebooks and scripts will live in the main project folder
