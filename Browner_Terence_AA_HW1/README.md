...
For the remote repository, make a github repository named BrownerTerenceAAHW1, then do;

```bash
git remote add origin git@github.com:terencebrowner/BrownerTerenceAAHW1.git
git branch -M main
...
Here's the folder structure that gets created by `cookiecutter-datascience-simple`:
	...
	├── BrownerTerenceAAHW1	<- Your notebooks and scripts will live in the main project folder
